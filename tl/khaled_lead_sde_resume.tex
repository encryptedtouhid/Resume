...
\section{Programming Skills}
  \resumeSubHeadingListStart
    ...
    \resumeSubItem{Miscellaneous : }
      {DelphiX, Open AI, AWS Ec2 T2, Route 53, Elastic Search, Azure AI Search, AWS AI Services, Crystal Report, PowerBI, Kubernetes, Docker, Kafka, RabbitMQ, Azure DevOps, Gitlab, Asana }
...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeItemListStart
      \resumeItem{}
        {Spearheaded the design and delivery of PEII Project, managing cross-functional teams to implement end-to-end solutions for trading and portfolio management operations using .NET Core, ReactJS microfrontend, GraphQL \& SQL Server.}
      \resumeItem{}
