...
% --------Multiple Positions Heading------------
  ...
  %   \resumeItemListEnd
    ...
    \resumeSubheading
      ...
      {Developed and implemented new functionality for the Nostro and Vostro modules, and integrated Active Directory authentication using \textbf{Microsoft AD services, ASP.NET WebForms (C\#), JQuery and Oracle database}.}
        \resumeItem{Agent Banking Solution}
          {Developed a fingerprint middleware service to standardize data from multiple fingerprint devices and implemented EKYC, CASH IN, and CASH OUT functionalities using \textbf{Crystal Reports, SourceAFIS, .NET (C\#), and Oracle database}.}
        \resumeItem{Mobile Banking Application}
          {Developed and implemented a mobile financial application and REST APIs for a reputed bank using \textbf{Xamarin, .NET Core and SQL SERVER}.}
      \resumeItemListEnd
