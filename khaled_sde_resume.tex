    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Electronic Health Records}
          {Led biweekly sprint discussions to brainstorm ideas and manage features and backlogs using Azure DevOps. Ensured conceptual completeness of technical solutions and managed quality and continuous improvement of architecture. Programmed and implemented a payment gateway service for a telemedicine application using .NET Core, adhering to ISO 8583 standards. Coordinated technical and business discussions with the team. Responsible for continuous integration and delivery of the Niramoy EHR application through the Azure DevOps CI/CD pipeline.}
