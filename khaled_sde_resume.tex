...
% --------Multiple Positions Heading------------
  ...
  %   \resumeItemListEnd
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{}
          {Implemented user interfaces for the doctor appointment module.}
        \resumeItem{}
          {Fixed a wide range of backend bugs raised by QA and support channels.}
        \resumeItem{}
          {Implement clean and maintainable code following best practices and design patterns..}
        \resumeItemListEnd
